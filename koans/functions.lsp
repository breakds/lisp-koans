...
(define-test test-func-with-rest-params
  ...
  (assert-equal (func-with-rest-params 1 :two 333)
                '(1 :two 333)))
...
(define-test test-key-params-can-have-defaults
   ...
   (assert-equal (func-key-params-can-have-defaults) 
                 '(3 nil 4 nil))
   (assert-equal (func-key-params-can-have-defaults :a 3 :b 4) 
                 '(3 t 4 t))
   (assert-equal (func-key-params-can-have-defaults :a 11 :b 22)
                 '(11 t 22 t))
   (assert-equal (func-key-params-can-have-defaults :b 22)
                 '(3 nil 22 t))
   ; order is not important
   (assert-equal (func-key-params-can-have-defaults :b 22 :a 0)
                 '(0 t 22 t)))
...
(define-test test-many-kinds-params
   ...
   (assert-equal (func-with-funky-parameters 1) 
                 '(1 nil 1 nil))
   (assert-equal (func-with-funky-parameters 1 :b 2) 
                 '(1 2 1 (:b 2)))
   (assert-equal (func-with-funky-parameters 1 :b 2 :c 3)
                 '(1 2 3 (:b 2 :c 3)))
   (assert-equal (func-with-funky-parameters 1 :c 3 :b 2)
                 '(1 2 3 (:c 3 :b 2))))
